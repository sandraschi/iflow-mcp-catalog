...
const BACKEND_NAME: &str = "iflow-mcp-catalog-backend.exe";
const BACKEND_PORT: u16 = 10809;
const BACKEND_TAG: &str = "iflow-mcp-catalog-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "IFLOW_MCP_CATALOG_PORT";
const ENV_HOST: &str = "IFLOW_MCP_CATALOG_HOST";
const ENV_TAURI: &str = "IFLOW_MCP_CATALOG_TAURI";
