...
4. Start the server:
   ...
   uv run python -m iflow_mcp_catalog.server

   # HTTP mode (for web dashboard)
   uv run uvicorn iflow_mcp_catalog.server:app --port 10809
   ```
...
5. Open `http://localhost:10809` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/iflow-mcp-catalog/issues) |
